                    ...
                    <div className={styles.header__content}>
                        <div className={styles.header__textContent}>
                            ...
                            <div className={styles.header__btnBox}>
                                ...
                                <button type={'button'} className={`${styles.button} ${styles.playVideo}`}>
                        ...
                        <div className={styles.header__imageContent}>
                                ...
                                <div className={`${styles.header__advertising} ${styles.header__service}`}>
                                ...
                                <div className={`${styles.header__advertising} ${styles.header__rating}`}>
                                    <div className={styles.header__advertising__gradeBox}>
                                        <div>4.5/5</div>
                                        <div className={styles.header__advertising__gradeBox_rating}>Rating</div>
                                    </div>
